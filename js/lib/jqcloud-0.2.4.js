    ...
    var drawWordCloud = function() {
      ...
      var hitTest = function(elem, other_elems){
        ...
        var overlapping = function(a, b){
          if (Math.abs(1.5*a.offsetLeft + a.offsetWidth - 1.5*b.offsetLeft - b.offsetWidth) < a.offsetWidth + b.offsetWidth) {
            if (Math.abs(1.5*a.offsetTop + a.offsetHeight - 1.5*b.offsetTop - b.offsetHeight) < a.offsetHeight + b.offsetHeight) {
              return true;
            }
          }
          return false;
      ...
      var drawOneWord = function(index, word) {
        ...
        var inner_html = word.url !== undefined ? "<a class='" + (word.type || "") +"' href='" + encodeURI(word.url).replace(/'/g, "%27") + "'>" + word.text + "</a>" : word.text;
